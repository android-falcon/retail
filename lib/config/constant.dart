...
final kStyleTextTextField = TextStyle(fontWeight: FontWeight.normal, fontSize: 24.sp);
final kStyleHeaderTable = TextStyle(fontWeight: FontWeight.bold, fontSize: 13.sp, color: AppColor.red);
const kStyleTextButton = TextStyle(fontWeight: FontWeight.bold,  color: Colors.white);
