...
class PhoneNumberFormField extends FormField<PhoneNumber> {
  PhoneNumberFormField({
    ...
    PhoneNumberFieldPrefixBuilder prefixBuilder = _buildPrefix,
          ...
          initialValue: controller != null ? controller.value : (initialValue ?? PhoneNumber.empty),
          validator: (value) {
  ...
  static Widget? _buildPrefix(BuildContext context, Country? country) {
    return PhoneNumberField.defaultPrefixBuilder != null ? PhoneNumberField.defaultPrefixBuilder!(context, country) : null;
  }
...
class _PhoneNumberFormFieldState extends FormFieldState<PhoneNumber> {
  ...
  PhoneNumberEditingController? get _effectiveController => widget.controller ?? _controller;
  ...
  void didUpdateWidget(covariant PhoneNumberFormField oldWidget) {
    ...
    if (widget.controller != oldWidget.controller) {
      ...
      if (oldWidget.controller != null && widget.controller == null) _controller = PhoneNumberEditingController(oldWidget.controller!.value!);
